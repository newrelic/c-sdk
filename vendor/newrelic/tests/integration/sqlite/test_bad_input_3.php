...
/*DESCRIPTION
The agent should gracefully handle sqlite_query() being invoked
...
function test_sqlite() {
  $result = sqlite_query("not a resource", "SELECT date(0, 'unixepoch');");
  if (false !== $result) {
    die("sqlite_query() should have failed");
  }
}
