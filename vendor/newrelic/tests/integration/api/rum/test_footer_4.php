...
/*DESCRIPTION
newrelic_get_browser_timing_footer(0) should return the RUM footer without a
...
newrelic_get_browser_timing_header(0);

$footer = newrelic_get_browser_timing_footer(0);
...
$footer2 = newrelic_get_browser_timing_footer(0);
