...
/*DESCRIPTION
newrelic_get_browser_timing_header(0) should return the RUM loader without a
...
$header = newrelic_get_browser_timing_header(0);
...
$header2 = newrelic_get_browser_timing_header(0);
