...
/*DESCRIPTION
The agent should gracefully handle SQLite3::query() being invoked with too many
arguments.
*/
...
function test_sqlite3() {
  ...
  $result = $conn->query("SELECT date(0, 'unixepoch');", "bad");

  if (false !== $result) {
    die("SQLite3::query() should have failed");
  }
}
