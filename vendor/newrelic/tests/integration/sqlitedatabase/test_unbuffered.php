...
/*DESCRIPTION
The agent should report Datastore metrics for SQLiteDatabase::unbufferedQuery().
*/
...
function test_sqlite() {
  ...
  $result = $conn->unbufferedQuery("SELECT * FROM test;");
  if (false === $result) {
    die("SQLiteDatabase::unbufferedQuery() should have returned a result");
  }
