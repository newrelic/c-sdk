...
/*DESCRIPTION
Tests the agent sends an obfuscated sql statment in transaction traces when LASP
configuration indicates record_sql:{enabled:true} and agent is configured to send
raw SQL. NOTE: RAW SQL is never sent for LASP enabled accounts, irrespective of client
configuration.
*/
