...
/*DESCRIPTION
Tests the agent sends a sql statment in transaction traces when LASP configuration
indicates record_sql:{enabled:true}, and agent is configured to send obfuscated SQL.
*/
