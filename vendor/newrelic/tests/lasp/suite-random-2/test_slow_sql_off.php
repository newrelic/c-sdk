...
/*DESCRIPTION
Tests that LASP has not introduced any bugs around the behavior of
newrelic.transaction_tracer.record_sql = "off" . (i.e. transaction
is not eligable for slow sql traces and we send nothing)
*/
