...
/*DESCRIPTION
Tests the agent sends no sql statment in transaction traces when LASP configuration
indicates record_sql:{enabled:false}, but agent is configured to send obfuscated SQL.
*/
