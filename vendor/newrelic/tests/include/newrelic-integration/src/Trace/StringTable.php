 ...
 *
 * String tables are used in
 * [condensed transaction traces](https://source.datanerd.us/agents/agent-specs/blob/master/Transaction-Trace-LEGACY.md),
 * such as those generated by the PHP agent.
 */
class StringTable
{
    /**
