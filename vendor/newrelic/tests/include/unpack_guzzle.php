 ...
 *
 * The guzzle.tar.bz2 archive contains Guzzle 5 and 6 installations and was
 * created based on a Guzzle installation made by @astorm. Other Guzzle
 * versions can be supported by adding Guzzle installations to the archive.
 */
