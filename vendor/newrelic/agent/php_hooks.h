 ...
 * (See http://www.php.net/manual/en/migration55.internals.php for a discussion
 * of what/how to override.)
 */
 ...
 * trace. This function is bound to zend_error_cb, and is typically called from
 * within the guts of zend_error. Params  : 1. A bitset encoding the
 * type of the error, taken from E_ERROR ... E_USER_DEPRECATED
 */
